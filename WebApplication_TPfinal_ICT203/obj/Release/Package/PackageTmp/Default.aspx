<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebApplication_TPfinal_ICT203._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DropDownList AutoPostBack="true" ID="DropDownListType" runat="server" Height="42px" Width="200px" OnSelectedIndexChanged="DropDownListType_SelectedIndexChanged">
