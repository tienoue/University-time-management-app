...
namespace WebApplication_TPfinal_ICT203
{
    public partial class consulter : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                string query = "SELECT heureDebut, heureFin, codeUE,nomEnseignant,codeSalle, datePassage from programmation where semestre="+Class1.semestre+" and nomFiliere='"+ Class1.filiere+ "' and codeNiveau='"+ Class1.niveau+ "'";
